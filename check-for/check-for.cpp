...
StatementMatcher LoopMatcher=forStmt(hasBody(nullStmt().bind("for")));
...
public :
  virtual void run(const MatchFinder::MatchResult &Result) {
	        ...
	        typedef NullStmt bin;
		const bin *FS;
	if (FS = Result.Nodes.getNodeAs<bin>("for"))
	{	
        ...
        cout<<fileName<<" "<<lineNum<<" "<<columnNum<<" err_for"<<"\n";	
